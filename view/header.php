...
<html lang="en" data-bs-theme="light">
  ...
  <head>
    ...
    <link rel="stylesheet" href="view/assets/vendors/slick/slick.css">
    <link rel="stylesheet" href="view/assets/vendors/mapbox-gl/mapbox-gl.min.css">
    <link rel="stylesheet" href="view/cdn.jsdelivr.net/npm/bootstrap-icons%401.9.1/font/bootstrap-icons.css">
  ...
  <body>
                    ...
                    <div class="dropdown-menu mega-menu start-0 py-6  w-100" aria-labelledby="menu-item-shop">
                      <div class="megamenu-shop container-wide py-8 px-12">
                        <div class="row">
                          ...
                          <div class="col">
                            <h6 class="fs-18px">Sản Phẩm bán chạy</h6>
                            <ul class="list-unstyled mb-0">
                              <?php
                      ...
                      <div class="menumega-docs px-8" style="min-width: 250px">
                        <a href="index.php?act=account" class="d-flex text-decoration-none mb-4 mb-lg-0" title="Documentation">
                          ...
                          <div class="flex-grow-1 ps-6">
                            <h6 class="mb-2">Quản lý tài khoản</h6>
    ...
    <script src="view/cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="view/assets/vendors/bootstrap/js/bootstrap.bundle.js"></script>
    <script src="view/assets/vendors/clipboard/clipboard.min.js"></script>
    <script src="view/assets/vendors/vanilla-lazyload/lazyload.min.js"></script>
    <script src="view/assets/vendors/waypoints/jquery.waypoints.min.js"></script>
    <script src="view/assets/vendors/lightgallery/lightgallery.min.js"></script>
    <script src="view/assets/vendors/lightgallery/plugins/zoom/lg-zoom.min.js"></script>
    <script src="view/assets/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js"></script>
    <script src="view/assets/vendors/lightgallery/plugins/video/lg-video.min.js"></script>
    <script src="view/assets/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js"></script>
    <script src="view/assets/vendors/isotope/isotope.pkgd.min.js"></script>
    <script src="view/assets/vendors/slick/slick.min.js"></script>
    <script src="view/assets/vendors/gsap/gsap.min.js"></script>
    <script src="view/assets/vendors/gsap/ScrollToPlugin.min.js"></script>
    <script src="view/assets/vendors/gsap/ScrollTrigger.min.js"></script>
    <script src="view/assets/vendors/mapbox-gl/mapbox-gl.js"></script>
    <script src="view/assets/js/theme.min.js"></script>
